...
class CTimeOutTimer : public CTimer
    ...
    public: // Constructors and destructors
        ...
        */
        ...
        void AfterTime(TTimeIntervalHours aInterval);
        void AfterTime(TTimeIntervalMinutes aInterval);
        void AfterTime(TTimeIntervalSeconds aInterval);
        void AfterTime(TTimeIntervalMicroSeconds32 aInterval);
    	void AfterInactivity(TTimeIntervalSeconds aSeconds);
